...
The predictions on the training set are 100% accurate.  However, the training set accuracy should not be used to estimate out-of-bag error since I have a sufficient number of training samples to use for cross validaion.
